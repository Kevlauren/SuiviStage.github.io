...
<head>
  <title>SuiviStage &mdash; Website by Colorlib</title>
  <meta charset="utf-8">
        ...
        <div class="d-flex align-items-center">
          <div class="site-logo">
            <a href="index.html" class="d-block">
              <img src="images/Suivi.png" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="mr-auto">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1><span style="color: #1072ac;">Suivi</span><span style="color: #d58a10;">Stage</span> </h1>
            </div>
          </div>
        </div>
      </div>

      <div class="intro-section" style="background-image: url('images/img3.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1>Solution n°1 des étudiants</h1>
            </div>
          </div>
        </div>
      </div>

      <div class="intro-section" style="background-image: url('images/img4.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1>Un suivi plus strict et rigoureux</h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p>Grâce à cet outil, les étudiants peuvent facilement trouver des opportunités de stages dans les entreprises de la place, sans se déplacer</p>
